...
Gradient_Descent(w,y_lab,w_bar,y_un,y_un_true,lc,verb,maxit,eps,fstop,stopcr);

%%%%%%% CODE FOR RUNNING BCGD RANDOMIZED GRADIENT DESCENT ALGORITHM

%[ygm,itergm,fxgm,tottimegm,fhgm,timeVecgm,gnrgm,accuracy]=...
%BCGD_Randomized(w,y_lab,w_bar,y_un,y_un_true,lc,verb,maxit,eps,fstop,stopcr);
